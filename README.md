...
<p align="center"><i>Python • SQL • Power BI • Machine Learning</i></p>

---

## 🧑‍💻 À propos de moi

Je suis **David Dufour**, Data Analyst en reconversion après plus de 20 ans dans le secteur bancaire.  
J’allie aujourd’hui :

✔️ Rigueur analytique  
✔️ Vision métier  
✔️ Capacité à vulgariser  
✔️ Maîtrise des outils modernes d’analyse  

🎯 Mon objectif : **transformer les données en leviers stratégiques** pour aider à la prise de décision.

---

## 🧠 Mes compétences (Vue d'ensemble)

<div align="center">

| Domaine | Détails |
|--------|---------|
| **Analyse & Préparation** | Nettoyage, EDA, cohérence, qualité des données |
| **Programmation** | Python (Pandas, NumPy, Sklearn), SQL |
| **Statistiques** | Tests, ACP, clustering, ML supervisé |
| **Data Viz** | Power BI, DAX, création de KPIs, storytelling |
| **Soft Skills** | Communication, pédagogie, gestion de projet |
...
## 📁 Mes projets de formation (P1 → P13)
...
<p align="center"><i>
Ce portfolio regroupe l'ensemble des projets réalisés dans le cadre de la formation Data Analyst – OpenClassrooms.
</i></p>
